...
valueField(doc, packet.summary?.category, 69, 335, 90, { size: 10, align: 'center', h: 18 })
valueField(doc, packet.stage?.label, 202, 335, 100, { size: 10, align: 'center', h: 18 })
valueField(doc, `${packet.readinessScore || ''}/100`, 335, 340, 95, { size: 10, align: 'center', h: 18 })
valueField(doc, dateText(packet.generatedAt), 459, 340, 78, { size: 10, align: 'center', h: 18 })
